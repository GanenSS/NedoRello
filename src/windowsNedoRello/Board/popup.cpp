...
void PopUp::show()
{
    ...
    QScreen* screen = QGuiApplication::screens().constFirst();
    QRect availableGeometry = screen->availableGeometry();

    setGeometry(
        availableGeometry.width() - 36 - width() + availableGeometry.x(),
        availableGeometry.height() - 36 - height() + availableGeometry.y(),
        width(),
        height()
        );
